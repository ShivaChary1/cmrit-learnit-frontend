...
import AttemptTestScreen from '@/screens/AttemptTestScreen';

const TestStack = createStackNavigator<TestStackParamList>();

const Exam = () => {
  return (
    <TestStack.Navigator initialRouteName="TestHome">
      <TestStack.Screen name="TestHome" component={TestScreen} options={{headerShown:false}}/>
      <TestStack.Screen name="AttemptTest" component={AttemptTestScreen} options={{headerShown:false}}/>
    </TestStack.Navigator>
  );
};
